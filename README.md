...
_Example CSV row of the Colosseum wave logger, it does not show the entire row_
...
- NPC list. For each relevant NPC, the following data is stored;
  ...
  - X and Y coordinate
  - HP and Max HP
Fremenniks, solarflares, totems, bees and beam crystals are optional and can be disabled via configurations.
